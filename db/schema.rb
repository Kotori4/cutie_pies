...
ActiveRecord::Schema.define(version: 2020_10_06_043854) do
  ...
  create_table "dog_post_comments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "dog_post_id"
    t.text "dog_post_comment", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["dog_post_id"], name: "index_dog_post_comments_on_dog_post_id"
    t.index ["user_id"], name: "index_dog_post_comments_on_user_id"
  end
  ...
  create_table "vet_comments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "vet_id"
    t.text "vet_comment", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_vet_comments_on_user_id"
    t.index ["vet_id"], name: "index_vet_comments_on_vet_id"
  end

  create_table "vets", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id"
  ...
  add_foreign_key "dog_post_comments", "dog_posts"
  add_foreign_key "dog_post_comments", "users"
  ...
  add_foreign_key "vet_comments", "users"
  add_foreign_key "vet_comments", "vets"
